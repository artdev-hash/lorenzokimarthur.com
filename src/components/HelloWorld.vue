<template>
  <div class="hello">
    <h1>{{ msg }}</h1>
    <p>
     I'm <a href="https://twitter.com/devkimlorenzo" target="_blank" rel="noopener"> <b>Kim Arthur Lorenzo</b> </a>, a **Self taught Developer** 👨‍💻 aspiring to become an Expert in the field of **Mobile** development.
    </p>
